...
//		cal = Calendar.getInstance();
    ...
    private void drawClockPoint(Canvas canvas) {
        ...
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 140, mPaint);//时针长度设置为65

        canvas.restore();
        canvas.save();
        canvas.rotate(minAngle,getWidth() / 2, getHeight() / 2);
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 240 , mPaint);//分针长度设置为90

        canvas.restore();
        canvas.save();
        canvas.rotate(secAngle,getWidth() / 2, getHeight() / 2);
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 310 , mPaint);//秒针长度设置为110
